...
<body class="sb-nav-fixed">
   <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
      ...
      <!-- Navbar Brand-->
      <a class="navbar-brand ps-3" href="index.php"> SIAP PAUD </a>
      <!-- Sidebar Toggle-->
      ...
      <div id="layoutSidenav_content" class="bgc">
         <main>
            ...
            <div class="container-fluid px-3 ">
               <?php
               $ambil_id = $_GET['id'];
               $laporan = mysqli_query($conn, "SELECT * FROM admin_peserta_didik WHERE id_laporan = '$ambil_id'");
               if (mysqli_num_rows($laporan) > 0) {
                  while ($p = mysqli_fetch_array($laporan)) {
               ?>
                     <ol class="breadcrumb mt-3 mb-2">
                        <li class="breadcrumb-item active" style="width:100%;">
                           <a style="text-decoration: none; color:gray; float:left;" href="laporan.php">Laporan</a> > Detail Laporan
                              ...
                              <div class="modal-dialog dialog-sm">
                                 <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                       <p style="color: black;">Yakin ingin menghapus laporan ini?</p>
                                    </div>
                                    <div class="modal-footer">
                                       <button type="button" class="btn btn-sm btn-secondary" data-bs-dismiss="modal">Batal</button>
                                       <a href="hapus-laporan.php?idlaporan=<?php echo $p['id_laporan']; ?>" class="btn btn-sm btn-danger">Hapus Laporan</a>
                                    </div>
                                 </div>
                              </div>
                           </div>
                     ...
                     ?>
                        <ol class="breadcrumb mt-0 mb-2">
                           <li class="breadcrumb-item" style="width:100%;">
                              <p style="float: left;"><b>Laporan Bulan : </b><?php echo $p['bulan']; ?> <?php echo $p['tahun']; ?></p>
                              <p style="float: right;"><b>Tanggal Upload : </b><?php echo $p['tanggal_kirim']; ?> </p>
                           </li>
                        </ol>
