            ...
            <div class="container-fluid px-3">
               ...
               <div class="card mb-4 bx-shadow">
                  ...
                  <div class="card-body">
                     ...
                     <form method="POST" action="edit-prasarana.php">
                        <table class="table table-bordered table-hover table-sm" id="font">
                           ...
                           <tbody>
                              ...
                              ?>
                                    ...
                                    <tr>
                                       <td>
                                          <input type="checkbox" style="height:18px; width:18px;" name="id_cek[]" value="<?php echo $tampil['id_prasarana'] ?>">
                                       </td>
                                       <td>
                                       ...
                                       <!-- <td>
                                    <a href="proses-hapus.php?id_prasarana=<?php echo $tampil['id_prasarana'] ?>" onclick="return confirm('yakin ingin menghapus data pendidik?')" >Hapus</a>
                                 </td> -->
                                    </tr>
                                 <?php
                                 }
                        ...
                        <tr>
                           ...
                           $lainnya = mysqli_query($conn, "SELECT * FROM sarana_dan_prasarana WHERE id_author = $id_author");
                           if (mysqli_num_rows($lainnya) > 0) {
                              // 
                           ?>
                              <div class="btn btn-success" style="padding: 0;">
                                 <input type="submit" name="submit" value="Edit Data" class="btn btn-success kirim" style="padding:5px 5px 5px 20px;">
                              </div>
                              <i style="font-size: 14px;"> (checklist kolom <b>Pilih</b> untuk mengubah data) </i>

                           <?php
                           } else {
                           ?>
                              <a href="tambah-sarana.php" class="btn btn-success"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 2 18 16">
