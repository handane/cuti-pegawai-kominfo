      ...
      <main>
        <div class="container-fluid px-3">
          <ol class="breadcrumb mb-4 mt-2">
            <li class="breadcrumb-item active">Update Data Admin</li>
          </ol>
          <div class="card">
            <div class="card-body">
              <?php
              if (isset($_GET['id_admin'])) {
                ...
                $edit = mysqli_query($conn, "SELECT * FROM admin WHERE id_admin = '" . $_GET['id_admin'] . "'");
                    ...
                    <form class="row g-3" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="col-md-6">
                        ...
                        <select class="form-select form-select-md" aria-label=".form-select-sm example" name="jenis_kelamin">
                          <option value="<?php echo $row['jenis_kelamin'] ?>">-- Jenis Kelamin --</option>
                      ...
                      <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="username" value="<?php echo $row['user_admin'] ?>" />
                      </div>
                      <div class="col-md-6">
                        <label for="" class="form-label-md"><b>Password</b></label>
                        <input type="text" class="form-control" name="password" value="<?php echo $row['pass_admin'] ?>" />
                      </div>
                      <div class="col-md-6">
