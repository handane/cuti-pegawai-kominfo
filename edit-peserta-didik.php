         ...
         <main>
            <div class="container-fluid px-3">
               ...
               <ol class="breadcrumb mb-4">
                  <li class="breadcrumb-item active"><a href="sarana-dan-prasarana" style="text-decoration: none; color:grey;">Peserta Didik</a> > Ubah Data</li>
               </ol>
                        ...
                        <table class="table table-bordered">
                           ...
                           <tbody class="ftn-pad">
                              ...
                              ?>
                                    ...
                                    <tr>
                                       <td>
                                          <input type="text" class="lebar" name="L12" value="<?php echo $lihat_peserta['L12'] ?>" />
                                       </td>
                                       <td>
                                          <input type="text" class="lebar" name="P12" value="<?php echo $lihat_peserta['P12'] ?>" />
                                       </td>
                                       <td>
                                          <input type="text" class="lebar" name="L3" value="<?php echo $lihat_peserta['L3'] ?>" />
                                       </td>
                                       <td>
                                          <input type="text" class="lebar" name="P3" value="<?php echo $lihat_peserta['P3'] ?>" />
                                       </td>
                                       <td>
                                          <input type="text" class="lebar" name="L4" value="<?php echo $lihat_peserta['L4'] ?>" />
                                       </td>
                                       <td>
                                          <input type="text" class="lebar" name="P4" value="<?php echo $lihat_peserta['P4'] ?>" />
                                       </td>
                                       <td>
                                          <input type="text" class="lebar" name="L56" value="<?php echo $lihat_peserta['L56'] ?>" />
                                       </td>
                                       <td>
                                          <input type="text" class="lebar" name="P56" value="<?php echo $lihat_peserta['P56'] ?>" />
                                       </td>
                                    </tr>
                        ...
                        <table class="table table-bordered">
                           ...
                           <tbody class="ftn-pad">
                              ...
                              ?>
                                    ...
                                    <tr>
                                       <td>
                                          <input type="text" class="lebar" name="pindah_masuk" value="<?php echo $lihat_peserta['pindah_masuk'] ?>" />
                                       </td>
                                       <td>
                                          <input type="text" class="lebar" name="pindah_keluar" value="<?php echo $lihat_peserta['pindah_keluar'] ?>" />
                                       </td>
                                       <td>
                                          <input type="text" class="lebar" name="baru" value="<?php echo $lihat_peserta['baru'] ?>" />
                                       </td>
                                       <td>
                                          <input type="text" class="lebar" name="berhenti" value="<?php echo $lihat_peserta['berhenti'] ?>" />
                                          <input type="hidden" class="" name="id_author" value="<?php echo $lihat_peserta['id_author'] ?>" />
                                       </td>
                                    </tr>
                              <?php
                                 }
               ...
               if (isset($_POST['save'])) {
                  ...
                  $update = mysqli_query($conn, "UPDATE peserta_didik SET
                          L12 = '$L12', 
                          P12 = '$P12', 
                          L3 = '$L3', 
                          P3 = '$P3',  
