...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=3939087876ltr&server=1">
...
<body>
    <div id="pma_navigation" data-config-navigation-width="221">
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sidini&table=user">`sidini`.`user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sidini&table=admin_peserta_didik">`sidini`.`admin_peserta_didik`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sidini&table=sarana_dan_prasarana">`sidini`.`sarana_dan_prasarana`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sidini&table=tabel_sarana">`sidini`.`tabel_sarana`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sidini&table=tenaga_pendidik">`sidini`.`tenaga_pendidik`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sidini&table=peserta_didik">`sidini`.`peserta_didik`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sidini&table=koderegistrasi">`sidini`.`koderegistrasi`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sidini&table=kegitan_pembelajaran_foto">`sidini`.`kegitan_pembelajaran_foto`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sidini&table=kegiatan_pembelajaran">`sidini`.`kegiatan_pembelajaran`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sidini&table=admin_tenaga_pendidik">`sidini`.`admin_tenaga_pendidik`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="677d2737655e6c322c2957225c60785d">
...
</span><small>Set to 0 to collapse navigation panel.</small></th><td><input type="number" name="NavigationWidth" id="NavigationWidth" class="custom" value="221"><a class="restore-default hide" href="#NavigationWidth" title="Restore default value"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_reload"></a></td></tr></table>
</fieldset>
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="sidini" targettable="admin_peserta_didik">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `admin_peserta_didik`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="sidini" targettable="admin_sarana_dan_prasarana">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `admin_sarana_dan_prasarana`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="sidini" targettable="kegiatan_lainnya">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `kegiatan_lainnya`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="sidini" targettable="admin_tenaga_pendidik">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `admin_tenaga_pendidik`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="sidini" targettable="kegiatan_pembelajaran">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `kegiatan_pembelajaran`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="sidini" targettable="kegitan_pembelajaran_foto">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `kegitan_pembelajaran_foto`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="sidini" targettable="koderegistrasi">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `koderegistrasi`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="sidini" targettable="peserta_didik">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `peserta_didik`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="sidini" targettable="sarana_dan_prasarana">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `sarana_dan_prasarana`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="sidini" targettable="tabel_sarana">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tabel_sarana`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="sidini" targettable="tenaga_pendidik">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tenaga_pendidik`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="sidini" targettable="user">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
