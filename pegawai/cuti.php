            ...
            <div class="card-body">
              <table id="datatablesSimple">
                ...
                <tbody>
                  ...
                  $get_pegawai = mysqli_query($conn, "SELECT * FROM pengajuan LEFT JOIN pegawai USING (id_pegawai) LEFT JOIN jenis_cuti USING (id_jeniscuti) WHERE id_pegawai = '$id_pegawai'");
                  ...
                  ?>
                    <tr style="font-size: 16px;" id="klik-tabel">
                      ...
                      <td>
                        ...
                        if ($p['status_cuti'] == 'Menunggu Persetujuan') {
                        ?>
                          <a class="btn btn-sm btn-danger" onclick="return confirm('apakah anda yakin ingin membatalkan permohonan cuti')" href="permohonan-delete.php?id_pengajuan=<?php echo $p['id_pengajuan'] ?>&id_pegawai=<?php echo $p['id_pegawai'] ?>">Delete</a>
                        <?php
                        } else if ($p['status_cuti'] == 'ditolak') {
                        ?>
                          <h6>-</h6>
