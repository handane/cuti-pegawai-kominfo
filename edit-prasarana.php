         ...
         <main>
            <div class="container-fluid px-3">
               ...
               <ol class="breadcrumb mb-4">
                  <li class="breadcrumb-item active"><a href="sarana-dan-prasarana" style="text-decoration: none; color:grey;">sarana dan prasarana</a> > ubah data</li>
               </ol>
               ...
               <div class="card mb-4">
                  ...
                  <div class="card-body">
                     <form method="POST" enctype="multipart/form-data">
                        <table class="table table-bordered table-sm" id="font">
                           ...
                           <tbody>
                              ...
                              for ($i = 0; $i < $jum; $i++) {
                                 $sarana = mysqli_query($conn, "SELECT * FROM sarana_dan_prasarana WHERE id_prasarana ='$id[$i]'");
                              ...
                              ?>
                                    <tr>
                                       ...
                                       <td>
                                          <input type="text" class="" name="jumlah[]" value="<?php echo $tampil['jumlah'] ?>" />
                                       </td>
                                       <td>
                                          <input type="text" class="" name="status_kepemilikan[]" value="<?php echo $tampil['status_kepemilikan'] ?>" />
                                       </td>
                                       <td>
                                          <input type="text" class="" name="kondisi[]" value="<?php echo $tampil['kondisi'] ?>" />
                                          <input type="hidden" class="" name="id_cek[]" value="<?php echo $tampil['id_prasarana'] ?>" />
                                          <input type="hidden" class="" name="id_author[]" value="<?php echo $tampil['id_author'] ?>" />
                                       </td>
                     ...
                     if (isset($_POST['save'])) {
                        ...
                        for ($i = 0; $i < $jum; $i++) {
                           $update = mysqli_query($conn, "UPDATE sarana_dan_prasarana SET
                          jenis = '$jenis[$i]', 
                          jumlah = '$jumlah[$i]',
                          status_kepemilikan = '$status_kepemilikan[$i]',
                          kondisi = '$kondisi[$i]',
                          id_author = '$id_author[$i]'
                          WHERE id_prasarana = '$id[$i]'");
                        }
                        if ($update) {
